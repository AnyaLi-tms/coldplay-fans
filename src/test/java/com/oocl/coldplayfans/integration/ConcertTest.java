...
public class ConcertTest {
    ...
    public void post_concert_should_create_successfully() throws Exception {
        List<Concert> givenConcerts = concertRepository.getAllConcerts();
        Concert newConcert = new Concert("Concert4", Date.valueOf("2022-08-01"), Time.valueOf("20:00:00"), "Wembley Stadium", "London", Date.valueOf("2025-07-01"), Time.valueOf("10:00:00"), "Description for Concert4", "https://www.coldplay.com/concert4/seatmap", Concert.Status.available, "https://www.coldplay.com/concert4.jpg");
